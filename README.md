...
<!--Wrapper-->
<div id="wrapper" class="mt-150 mb-150" data-easytabs="true">
	...
	<header id="header">
		...
		<!--End left content-->
			...
			<div class="col-md-9 right-content pd-r0 pd-l0">
						...
						<!--About Tab-->
					<section id="about" class="bg-white t-center active" style="display: block;">
					...
					<!--End content-->
						...
						<!--End about tab-->
							...
							<!--Resume Tab-->
						<section id="resume" class="bg-white t-center" style="display: none;">
						...
						<div class="block-content mb-100  pb-10">
							...
							<div class="col-md-12  ">
								...
								<div class="timeline">
									...
									<div class="timeline-inner">
										<div class="name">
											<span class="date">August 2003 - June 2012</span>
				...
				<div class="block-content mb-100 ">
					...
					<div class="row">
						...
						<div class="testi clearfix ">
							...
							<ul id="testimonial-carousel" class="owl-carousel owl-theme" style="opacity: 0; display: block;">
							<div class="owl-wrapper-outer"><div class="owl-wrapper" style="width: 400px; left: 0px; display: block; transition: all 400ms ease 0s; transform: translate3d(-100px, 0px, 0px);"><div class="owl-item" style="width: 100px;"><li>
							 ...
							 </li></div><div class="owl-item" style="width: 100px;"><li>
								<div class="block-quote t-left">
										<blockquote>“Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod 
											tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, 
											quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.
							...
							<div class="owl-controls clickable"><div class="owl-pagination"><div class="owl-page"><span class=""></span></div><div class="owl-page active"><span class=""></span></div></div></div></ul>	
			...
			<!--End resume tab-->
							...
							<!--Portfolio Tab-->
						<section id="portfolio" class="bg-white t-center" style="display: none;">
								...
								<div class="row">
									...
									<div class="col-md-12">
										...
										<div class="main-title ">
			                               ...
			                               <h5 class="uppercase">My Works</h5>
			                           </div>
						...
						<!--Block filter-->
						<div class="block-filter uppercase mb-40">
						...
						<!--End row-->
							...
							<div class="row">
								...
								<li class="col-sm-6 ">
									...
									<a href="project_single.html">
										<div class="desc">
										<h5 class="proj-desc">Project Name
										 <span>Web design</span></h5>
										</div>
								...
								<!--Item-->	
								<div class="item web">
								<a href="img/portfolio/2.jpg" class="popup">
									<div class="desc">
									<h5 class="proj-desc">Project Name
									 <span>Web design</span></h5>
									</div>
							...
							<li class="col-sm-6">
								...
								<a href="img/portfolio/3.jpg" class="popup">
									<div class="desc">
									<h5 class="proj-desc">Project Name 
									<span>Graphic design</span></h5>
									</div>
							...
							<li class="col-sm-6">
								...
								<!--Item-->	
								<div class="item web">
								<a href="img/portfolio/4.jpg" class="popup">
									<div class="desc">
									<h5 class="proj-desc">Project Name
									 <span>Web design</span></h5>
									</div>
							...
							<li class="col-sm-6">
								...
								<!--Item-->	
								<div class="item graphic">
								<a href="img/portfolio/5.jpg" class="popup">
									<div class="desc">
									<h5 class="proj-desc">Project Name
									 <span>Graphic design</span></h5>
									</div>
							...
							<li class="col-sm-6">
								...
								<!--Item-->	
								<div class="item web">
								<a href="img/portfolio/6.jpg" class="popup">
									<div class="desc">
									<h5 class="proj-desc">Project Name
									 <span>Web design</span></h5>
									</div>
							...
							<li class="col-sm-6">
								...
								<a href="https://vimeo.com/67429593" class="popup-vimeo">
									<div class="desc">
									<h5 class="proj-desc">Project Name
									<span>Motion graphic</span></h5>
									</div>
							...
							<li class="col-sm-6">
								...
								<!--Item-->	
								<div class="item graphic">
								<a href="img/portfolio/9.jpg" class="popup">
									<div class="desc">
									<h5 class="proj-desc">Project Name
									 <span>Graphic design</span></h5>
									</div>
							...
							<li class="col-sm-6 ">
								...
								<!--Item-->	
								<div class="item graphic">
								<a target="_blank" href="http://www.mutationmedia.net/">
									<div class="desc">
									<h5 class="proj-desc">Project Name
									 <span>Graphic design</span></h5>
									</div>
							...
							<li class="col-sm-6">
								...
								<!--Item-->	
								<div class="item web">
								<a href="img/portfolio/11.jpg" class="popup">
									<div class="desc">
									<h5 class="proj-desc">Project Name
									 <span>Web design</span></h5>
									</div>
							...
							<li class="col-sm-6">
								...
								<!--Item-->	
								<div class="item motion">
								<a href="https://www.youtube.com/watch?v=gTFljCRnGN4" class="popup-youtube">
									<div class="desc">
									<h5 class="proj-desc">Project Name
									 <span>Motion graphic</span></h5>
									</div>
					...
					<div class="block-content">
							...
							<div class="row">
						<div class="col-md-12">
							<span class="page-number emph-1">- 3/5 -</span>
						</div>
			...
			<!--End portfolio tab-->
							...
							<!--Blog Tab-->
						<section id="blog" class="bg-white t-center" style="display: none;">
							...
							<a class="but" href="blog.html">View All Blog Posts<span class="right-arr">→</span></a>		
						...
						<!--End blog tab-->
							...
							<!--Contact Tab-->
						<section id="contact" class="bg-white t-center" style="display: none;">
